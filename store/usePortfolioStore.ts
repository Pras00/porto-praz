...
export const usePortfolioStore = create<PortfolioState>((set, get) => ({
  developerInfo: initialInfo,
  projects: initialProjects,
  experiences: initialExperiences,
  educationList: initialEducation,
  ...
  importBackupJSON: async (jsonString: string) => {
    try {
      ...
      set({
        developerInfo: parsed.developerInfo || initialInfo,
        projects: parsed.projects || initialProjects,
        experiences: parsed.experiences || initialExperiences,
        educationList: parsed.educationList || initialEducation,
